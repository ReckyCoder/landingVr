    ...
    return (
        <>
            <div className="relative w-full max-w-[255px] h-[270px] group overflow-hidden rounded-xl bg-white border border-[#E5E5E5]">
                ...
                <div className=" absolute inset-0 p-6 colorbgRed text-white opacity-0 -translate-y-4 transition-all duration-500 ease-out group-hover:opacity-40 group-hover:translate-y-0">
