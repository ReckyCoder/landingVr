                    ...
                    <SwiperSlide>
                        <div className='max-w-[600px] mx-auto 2xl:max-w-full grid grid-cols-2 justify-center 2xl:justify-between 2xl:grid-cols-3 items-center z-1'>
                            ...
                            <div className='flex justify-center items-center relative col-span-2 2xl:col-span-1'>
                                <img className='w-20 2xl:w-[418px] h-[818px] 2xl:h-[721px] absolute right-0 -z-1 2xl:visible 2xl:relative' src={rectangle} alt="" />
                            ...
                            <div className='max-w-[300px] mx-auto flex flex-col gap-y-6'>
                                ...
                                <a href='#' className='font-bold text-[14px] bg-primary-red text-white rounded-[20px] py-2 px-5 w-fit cursor-pointer'>{data.contenido.link}</a>
                            </div>
                        </div>
                    </SwiperSlide>
                    ))}
