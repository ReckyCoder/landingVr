...
export default function CardTransformacionDigital({
  ...
  return (
    <div className="relative w-full max-w-sm h-[346px] group overflow-hidden rounded-xl bg-white border border-[#E5E5E5]">
      {/* Contenido frontal */}
      <div className="mt-5 absolute inset-0 p-6 transition-opacity duration-300 ease-in-out group-hover:opacity-0">
      ...
      <div className=" cursor-pointer absolute inset-0 p-6 colorbgRed text-white opacity-0 -translate-y-4 transition-all duration-500 ease-out group-hover:opacity-100 group-hover:translate-y-0">
