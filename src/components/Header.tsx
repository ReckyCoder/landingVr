...
export default function Header() {
    ...
    const styleHeader = "w-full grid grid-cols-3 items-center justify-between colorBg h-[70px] transition-all duration-500 z-3 fixed"

    return (
        <header ref={headerRef} className={isSticky ? styleHeader + ' top-0' : styleHeader + ' -top-80'}>
